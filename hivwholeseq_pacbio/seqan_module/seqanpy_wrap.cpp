...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__seqanpy

#else
#  define SWIG_init    init_seqanpy

#endif
#define SWIG_name    "_seqanpy"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_nothing(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
