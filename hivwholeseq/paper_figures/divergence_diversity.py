...
from hivwholeseq.paper_figures.plots import plot_divergence_diversity
...
if __name__ == '__main__':
    ...
    # Plot
    filename = foldername+'divdiv'
    for ext in ['png', 'pdf', 'svg']:
        plot_divergence_diversity(data,
                                  VERBOSE=VERBOSE,
                                  savefig=filename+'.'+ext)

    plot_divergence_diversity(data, VERBOSE=VERBOSE)
