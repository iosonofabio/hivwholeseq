...
if __name__ == '__main__':
    ...
    for PCRtype in ('PCR1', 'PCR2'):
        ...
        # Go down to the reads
        bamfilename = get_mapped_to_initial_filename(pname, samplename, fragment, filtered=True)
